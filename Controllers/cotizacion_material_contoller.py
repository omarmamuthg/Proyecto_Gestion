...
class CotizacionMaterialController:
    ...
    #     # Pasar la conexión establecida a los repositorios
    #     self.cotizacion_material_repo = CotizacionMaterialRepository(self.conn)
    #     self.cotizacion_repo = CotizacionRepository(self.conn)
    #     self.proveedor_material_repo = ProveedorMaterialRepository(self.conn)  # Ahora recibe la conexión, no el string

    # def __init__(self, connection_string: str):
    #     # Pasar directamente la cadena de conexión a los repositorios
    ...
    #     # Guardar usando float
    #     return self.repo.agregar_material(
