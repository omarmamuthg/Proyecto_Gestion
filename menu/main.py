...
# #-------------------------------------------------------------------------------------------------------------------------------------
        ...
        while True:
            ...
            #                 for m in materiales:
            #                     print(f"ID: {m.id_material} - {m.nombre} ({m.unidad_medida}) - ${m.costo_unitario}")
            ...
            #                         print(f"4. Costo unitario: ${material.costo_unitario}")
            #                         print(f"5. Marca: {material.marca or 'No especificada'}")
            #                         print(f"6. Categoría: {material.categoria or 'No especificada'}")
            ...
            #                                     if decimal_val <= 0:
            #                                         errores.append(f"- El costo debe ser mayor que cero")
            #                                         return False
            #                                 except:
            #                                     errores.append(f"- Ingrese un número válido (ej. 150.50)")
            #                                     return False
            ...
            #                             "costo_unitario": input("Nuevo costo (ej. 150.50, ENTER para mantener): ").strip(),
            ...
            #                         if nuevos_datos["costo_unitario"]:
            #                             validar_edicion(nuevos_datos["costo_unitario"], "costo unitario", "decimal")
            ...
            #                     else:
            #                         id_eliminar = int(id_eliminar)  # Conversión a entero
            #                         material = controller.obtener_material(id_eliminar)
                                    
            #                         if not material or not material.activo:
            #                             print("\n❌ No existe un material activo con ese ID")
            #                         else:
            #                             # Confirmación con detalles
            #                             print("\n⚠️ ATENCIÓN: Esta acción marcará el material como INACTIVO")
            #                             print(f"ID: {material.id_material}")
            #                             print(f"Nombre: {material.nombre}")
            #                             print(f"Unidad de Medida: {material.unidad_medida}")
            #                             print(f"Categoría: {material.categoria or 'No especificada'}")
            #                             print(f"Marca: {material.marca or 'No especificada'}")
            #                             print(f"Costo Unitario: ${material.costo_unitario}")
            #                             print(f"Fecha Registro: {material.fecha_registro.strftime('%d/%m/%Y')}")
                                        
            #                             confirmar = input("\n¿ESTÁ SEGURO que desea continuar? (s/n): ").lower()
            #                             if confirmar == 's':
            #                                 if controller.eliminar_material(id_eliminar):
            #                                     print("\n✅ Material marcado como inactivo correctamente")
            #                                     # Mostrar datos del material inactivado
            #                                     material_inactivado = controller.obtener_material(id_eliminar)
            #                                     print(f"\nDetalles del material inactivado:")
            #                                     print(f"Estado actual: {'ACTIVO' if material_inactivado.activo else 'INACTIVO'}")
            #                                 else:
            #                                     print("\n❌ Error al marcar el material como inactivo")
            #                             else:
            #                                 print("Operación cancelada por el usuario")
            #                                 limpiar_pantalla()
            #                                 break
            ...
            #                                 resultado = controller.eliminar_material(id_eliminar)
            #                                 if resultado:
            #                                     print("\n✅ Material marcado como inactivo correctamente")
            #                                 else:
            #                                     print("\n❌ No se pudo completar la operación")
            #                                     print("ℹ️ Posibles causas:")
            #                                     print("- El material ya estaba inactivo")
            ...
            #                     # Verificar si el ID está en la lista de activos mostrada
            #                     material = next((m for m in materiales if m.id_material == id_eliminar), None)
                                
            #                     if not material:
            #                         print("\n❌ No existe un material activo con ese ID en la lista mostrada")
            #                     else:
            #                         # Confirmación con detalles
            #                         print("\n⚠️ ATENCIÓN: Esta acción marcará el material como INACTIVO")
            #                         print(f"ID: {material.id_material}")
            ...
            #                                 print("ℹ️ Posibles causas:")
            #                                 print("- Error de conexión con la base de datos")
            #                                 print("- Problema con los permisos")
            #                         else:
            #                             print("Operación cancelada por el usuario")
            ...
            #                     print(f"Costo Unitario: ${m.costo_unitario}")
